...
ALTER TABLE node_versions ADD COLUMN IF NOT EXISTS created_by BIGINT REFERENCES users(id) ON DELETE SET NULL;

-- +goose Down
ALTER TABLE node_versions DROP COLUMN IF EXISTS created_by;
