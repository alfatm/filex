...
import { DUPLICATE_NAME, FileLimitExceeded, INVALID_NAME, ROLE_FORBIDDEN, UploadRateLimited } from '@/data/repository';
...
// Said before the request rather than after it: the server refuses `a/b` and `..`, and for `..` the refusal used
// to arrive as "That name is already taken" — the parent folder, which of course exists.
